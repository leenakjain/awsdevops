...
public class StripeService {
     ...
     * @throws com.lnk.awsdevops.exceptions.StripeException If an error occurred while interacting with Stripe
     */
    public String createCustomer(Map<String, Object> tokenParams, Map<String, Object> customerParams) {
        ...
        try {
            ...
            throw new com.lnk.awsdevops.exceptions.StripeException(e);
