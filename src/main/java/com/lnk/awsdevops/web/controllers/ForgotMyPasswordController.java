...
import com.lnk.awsdevops.backend.persistence.domain.backend.PasswordResetToken;
import com.lnk.awsdevops.backend.persistence.domain.backend.User;
import com.lnk.awsdevops.backend.service.EmailService;
import com.lnk.awsdevops.backend.service.I18NService;
import com.lnk.awsdevops.backend.service.PasswordResetTokenService;
...
public class ForgotMyPasswordController {
    ...
    public String forgotPasswordPost(HttpServletRequest request,
        ...
        if (null == passwordResetToken) {
            ...
            mailMessage.setSubject("[awsdevops]: How to Reset Your Password");
